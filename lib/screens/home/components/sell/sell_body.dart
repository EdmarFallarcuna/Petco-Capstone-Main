...
import 'sell_list.dart';

class SellBody extends HookWidget {
  const SellBody({Key? key}) : super(key: key);
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: getProportionateScreenWidth(10)),
            Expanded(child: SellList(list: list.value,search: searchText.value,)),
          ],
        ),
      ),
    );
