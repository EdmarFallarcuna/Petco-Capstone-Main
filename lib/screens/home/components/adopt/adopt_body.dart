...
import 'adopt_list.dart';

class AdoptBody extends HookWidget {
  const AdoptBody({Key? key}) : super(key: key);
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: getProportionateScreenWidth(10)),
            Expanded(child: AdoptList(list: list.value,search: searchText.value,)),
          ],
        ),
      ),
    );
